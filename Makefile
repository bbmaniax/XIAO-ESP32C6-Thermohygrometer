...
define deploy-openocd
	$(HOME)/.arduino15/packages/ch32-riscv-arduino/tools/openocd/1.91/bin/openocd \
		-f $(HOME)/.arduino15/packages/ch32-riscv-arduino/tools/openocd/1.91/bin/$(3) \
...
deploy/ch32v003:
	$(call deploy-openocd,ch32-riscv-arduino:ch32riscv:CH32V003_EVT,$(basename $(SKETCH)),wch-riscv.cfg)
